...
## makeCacheMatrix is used to create a list of functions to set and retrieve cached matrix values.
## cacheSolve is used to calculate and return the inverse of the matrix and stored the value in cache. 
## On the next invocation of cacheSolve, the function will return the cached value instead of 
## redoing the calculation.

## makeCacheMatrix accepts a matrix and returns a list of functions.
## The list includes functions to get and set the value of matrix and its inverse.
...
## cacheSolve accepts a list of functions created by makeCacheMatrix and returns the inverse of the matrix
